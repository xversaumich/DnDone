...
export function AbilityScore({ label, value, onChange }: AbilityScoreProps) {
  ...
  return (
    <div className="bg-white border border-gray-400 rounded-lg flex flex-col items-center aspect-square p-1">
      ...
      {/* Label tight to top */}
      <span className="text-black font-semibold leading-none mt-0.5" style={{ fontSize: "10px" }}>
        {label}
      </span>

      {/* Smaller centered gray perfect square */}
      <div className="bg-gray-100 border border-gray-300 rounded-md aspect-square flex items-center justify-center my-1"
           style={{ width: "70%" }}>
      ...
      <span className="text-black leading-none mb-0.5" style={{ fontSize: "10px" }}>
        {value}
      </span>
    </div>
  );
