    ...
    <div className="bg-white border border-gray-400 rounded-lg flex flex-col items-center aspect-square p-1">
      ...
      >
        ...
        <input
          ...
          style={{
            color: "transparent",     // ← hides the ghost zero
            caretColor: "black",      // ← cursor stays visible
            fontSize: "22px",
            fontWeight: 600,
        ...
        {/* Visible +X overlay */}
        <div
          className="pointer-events-none text-black flex items-center justify-center absolute inset-0"
          style={{
            fontSize: "22px",
            fontWeight: 600,
          }}
