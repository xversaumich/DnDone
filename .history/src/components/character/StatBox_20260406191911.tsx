      ...
      {isSpeed ? (
        ...
        <div className="relative w-full">
          <input
            ...
            readOnly={readOnly}
            className="w-full pr-10 pl-2.5 py-1 bg-input-background border border-border rounded-md text-left disabled:opacity-50"
            disabled={readOnly}
          />
          <span className="absolute right-2 top-1/2 -translate-y-1/2 text-sm text-gray-400 font-medium">
            ft
          </span>
        </div>
      ) : (
