  ...
  return (
    <div className="bg-white border border-gray-400 rounded-lg flex flex-col items-center aspect-square p-1 relative">
      ...
      >
        ...
        {/* REAL number input (arrows) but invisible text */}
        <input
          type="number"
          value={modifier}
          onChange={(e) => {
      ...
      {/* +X sits to the RIGHT of the gray box, inside the white box */}
      <div
        className="pointer-events-none absolute"
        style={{
          top: "50%",
          transform: "translateY(-50%)",
          right: "8px",          // ← moves it to the right edge of the white box
          fontSize: "22px",
          fontWeight: 600,
          color: "black",
        }}
