...
export function SpellSection({
  ...
  return (
    <div className="-mt-1 mb-6">
      ...
      {/* label and icon on the same line */}
      <div className="flex items-center justify-between mb-1">
        <h2 className="text-amber-900 border-b-2 border-amber-700 pb-1">
          Spellcasting
        </h2>
        ...
        <button
          ...
          className="text-amber-900 text-xl ml-3"
        >
          ≡
        </button>
      </div>

      {/* dropdown content under the line */}
      {open && (
