...
export function SkillsSection({ character, skills, onToggleSkill }: SkillsSectionProps) {
  return (
    <div className="mb-6">
      ...
      {/* ⭐ One big gray box — same height as Ability Scores */}
      <div
        ...
        style={{
          ...
          justifyContent: "flex-start",   // ← sits at the top
        }}
      >

        {/* Column of skill rows with more spacing */}
        <div className="flex flex-col gap-3">   {/* ← increased from gap-2 to gap-3 */}
