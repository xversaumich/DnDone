...
export function CharacterPortraitSection({
  ...
  return (
    <section>
      <h2 className="text-amber-900 mb-4 border-b-2 border-amber-700 pb-2 w-full">Portrait Prompt</h2>
  ...
  <div className="mt-2">
    ...
    <div className="mt-4 p-4 bg-[#F7F2E3] rounded-lg border border-[#C96A00] text-sm text-[#5C4033]">
      <p><strong>Tip:</strong> Copy this prompt and paste it into your favorite AI image generator (such as DALL-E, Midjourney, Stable Diffusion, etc.) to create a character portrait.</p>
    </div>
  </div>
)}
      </div>
